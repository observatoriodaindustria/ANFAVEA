...
from valores_uteis import engine, caminho_arquivo, nomes_planilhas
...
def licenciamento_motorizacao(ini_linha=5, tam_tabela=3, df=df_base, tipo_licenciamento='Licenciamento total de automóveis por motorização'):
    ...
    df_unidirecional.to_sql('anfavea_lic_motorizacao', con=engine, schema='st', if_exists='replace', index_label='id_motorizacao')
